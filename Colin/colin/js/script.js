(function($) {
	...
	if($('.main-header li.dropdown ul').length){
		$('.main-header .navigation li.dropdown').append('<div class="dropdown-btn"><span class="fa fa-angle-left"></span></div>');
	...
	if ($('.testimonial-carousel-three').length) {
		$('.testimonial-carousel-three').owlCarousel({
			...
			autoplay: true,
			autoplayTimeout:10000,
			navText: [ '<span class="flaticon-right-arrow-1"></span>', '<span class="flaticon-left-arrow"></span>' ],
			responsive:{
				0:{
					items:1
				},
